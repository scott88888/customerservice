...
class Ip
{
    ...
    public static function check_country($ip){
        $ip_arr = self::find($ip);
        $country = $ip_arr[0]?:$ip_arr[1];
        $country_arr = config('country');
        return array_search($country,$country_arr);
    }
    ...
    private static function getLocationCode($arr)
    {
        ...
        $locationCode["山西"] = [
            "code" => "140000",
            "city" => ["太原市" => "140100", "大同市" => "140200", "阳泉市" => "140300", "長治市" => "140400", "晋城市" => "140500", "朔州市" => "140600", "晋中市" => "140700", "运城市" => "140800", "忻州市" => "140900", "临汾市" => "141000", "吕梁市" => "141100"],
        ];
        $locationCode["内蒙古"] = [
            "code" => "150000",
        ...
        $locationCode["吉林"] = [
            "code" => "220000",
            "city" => ["長春市" => "220100", "吉林市" => "220200", "四平市" => "220300", "辽源市" => "220400", "通化市" => "220500", "白山市" => "220600", "松原市" => "220700", "白城市" => "220800", "延边朝鲜族自治州" => "222400"],
        ];
        $locationCode["黑龙江"] = [
            "code" => "230000",
        ...
        $locationCode["江苏"] = [
            "code" => "320000",
            "city" => ["南京市" => "320100", "無锡市" => "320200", "徐州市" => "320300", "常州市" => "320400", "苏州市" => "320500", "南通市" => "320600", "连云港市" => "320700", "淮安市" => "320800", "盐城市" => "320900", "扬州市" => "321000", "镇江市" => "321100", "泰州市" => "321200", "宿迁市" => "321300"],
        ];
        $locationCode["浙江"] = [
            "code" => "330000",
        ...
        $locationCode["河南"] = [
            "code" => "410000",
            "city" => ["郑州市" => "410100", "開封市" => "410200", "洛阳市" => "410300", "平顶山市" => "410400", "安阳市" => "410500", "鹤壁市" => "410600", "新乡市" => "410700", "焦作市" => "410800", "濮阳市" => "410900", "许昌市" => "411000", "漯河市" => "411100", "三门峡市" => "411200", "南阳市" => "411300", "商丘市" => "411400", "信阳市" => "411500", "周口市" => "411600", "驻马店市" => "411700", "济源市" => "419001"],
        ];
        $locationCode["湖北"] = [
            "code" => "420000",
        ...
        $locationCode["湖南"] = [
            "code" => "430000",
            "city" => ["長沙市" => "430100", "株洲市" => "430200", "湘潭市" => "430300", "衡阳市" => "430400", "邵阳市" => "430500", "岳阳市" => "430600", "常德市" => "430700", "张家界市" => "430800", "益阳市" => "430900", "郴州市" => "431000", "永州市" => "431100", "怀化市" => "431200", "娄底市" => "431300", "湘西土家族苗族自治州" => "433100"],
        ];
        $locationCode["广东"] = [
            "code" => "440000",
        ...
        $locationCode["西藏"] = [
            "code" => "540000",
            "city" => ["拉萨市" => "540100", "昌都地区" => "542100", "山南地区" => "542200", "日喀則地区" => "542300", "那曲地区" => "542400", "阿里地区" => "542500", "林芝地区" => "542600"],
        ];
        $locationCode["陕西"] = [
            "code" => "610000",
        ...
        $locationCode["新疆"] = [
            "code" => "650000",
            "city" => ["乌鲁木齐市" => "650100", "克拉玛依市" => "650200", "吐鲁番地区" => "652100", "哈密地区" => "652200", "昌吉回族自治州" => "652300", "博尔塔拉蒙古自治州" => "652700", "巴音郭楞蒙古自治州" => "652800", "阿克苏地区" => "652900", "克孜勒苏柯尔克孜自治州" => "653000", "喀什地区" => "653100", "和田地区" => "653200", "伊犁哈萨克自治州" => "654000", "塔城地区" => "654200", "阿勒泰地区" => "654300", "石河子市" => "659001", "阿拉尔市" => "659002", "圖木舒克市" => "659003", "五家渠市" => "659004"],
        ];
        $code = "";
