    ...
    public function trans(){
        if($this->request->isAjax()){
            ...
            if($business['trans_type']){
                if(isset($post['to'])&&$post['to']) $to = config('lang_trans_g')[$post['to']];
                $stream_opts = [
                    "ssl" => [
                        "verify_peer"=>false,
                ...
                $query = http_build_query([
                    ...
                    "target" => $to,
                    "format" => 'text',
                    "key"=> $business['google_trans_key']?:config('google_trans_key'),
                ]);
                try{
                    ...
                    if(isset($res['data']['translations']['translatedText'])){
