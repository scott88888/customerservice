...
UE.I18N['zh-cn'] = {
    ...
    'autofloatMsg':"工具栏浮动依赖編輯器UI，您首先需要引入UI文件!",
    'loadconfigError': '取得后台配置项请求出错，上传功能将不能正常使用！',
    ...
    'insertimage':{
        ...
        'updateStatusConfirm': '已成功上传_张照片，_张照片上传失敗',
        'updateStatusFinish': '共_张（_KB），_张上传成功',
        'updateStatusError': '，_张上传失敗。',
        'errorNotSupport': 'WebUploader 不支持您的浏览器！如果你使用的是IE浏览器，请尝试升级 flash 播放器。',
        'errorLoadConfig': '后端配置项没有正常加载，上传插件不能正常使用！',
        'errorExceedSize':'文件大小超出',
        'errorFileType':'文件格式不允许',
        'errorInterrupt':'文件传输中断',
        'errorUploadRetry':'上传失敗，请重试',
        'errorHttp':'http请求错误',
    ...
    'attachment':{
        ...
        'updateStatusConfirm': '已成功上传_个文件，_个文件上传失敗',
    ...
    'insertvideo':{
        ...
        'uploadPreview':'预览中',
        'updateStatusReady': '选中_个文件，共_KB。',
        'updateStatusConfirm': '成功上传_个，_个失敗',
    ...
    'help':{
        'static':{
            ...
            'lang_input_introduction':'UEditor是由百度web前端研发部开发的所见即所得富文本web編輯器，具有轻量，可定制，注重使用者体验等特点。开源基于BSD协议，允许自由使用和修改代码。',
