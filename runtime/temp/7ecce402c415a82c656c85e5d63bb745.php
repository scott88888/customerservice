<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"/www/wwwroot/web/public/../application/service/view/banwords/index.html";i:1635419214;}*/ ?>
						...
						<div class="layui-form-item layui-inline">
							...
							<div class="layui-input-inline">
								<select name="lang">
									...
									<?php $_667aa10dd1d88=config('lang'); if(is_array($_667aa10dd1d88) || $_667aa10dd1d88 instanceof \think\Collection || $_667aa10dd1d88 instanceof \think\Paginator): if( count($_667aa10dd1d88)==0 ) : echo "" ;else: foreach($_667aa10dd1d88 as $key=>$vo): ?>
