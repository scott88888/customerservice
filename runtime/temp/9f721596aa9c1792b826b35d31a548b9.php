<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"/www/wwwroot/web/public/../application/service/view/login/index.html";i:1720165288;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title><?php echo (isset($business['business_name']) && ($business['business_name'] !== '')?$business['business_name']:"線上客服管理系統"); ?></title>
        ...
        <form class="layui-form login-bottom">
            <div class="center">
                <div class="item">
                    ...
                    <input type="text" name="username" lay-verify="required"  placeholder="請輸入登入帳號" maxlength="24"/>
                </div>

                <div class="item">
                    <span class="icon icon-3"></span>
                    <input type="password" name="password" lay-verify="required"  placeholder="請輸入密碼" maxlength="20">
                    <span class="bind-password icon icon-4"></span>
                </div>

                <div id="validatePanel" class="item" style="width: 137px;">
                    <input type="text" name="captcha" placeholder="請輸入驗證碼" maxlength="4">
                    <img id="refreshCaptcha" class="validateImg"  src="<?php echo url('captcha'); ?>" onclick="this.src='<?php echo url('captcha'); ?>?_r='+Math.random();" title="不清楚? 點選換一個">
                </div>

            </div>
            <div class="layui-form-item" style="text-align:center; width:100%;height:100%;margin:0px;">
                <button class="login-btn" lay-submit="" lay-filter="login">立即登入</button>
            </div>
        </form>
    </div>
</div>
<div class="footer">    
©版權所有 <?php echo date('Y'); ?> AI客服系統
</div>
