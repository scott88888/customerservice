...
//WSS证书', '一般為fullchain.pem，宝塔默認位置：/www/server/panel/vhost/ssl/YOU DOMAIN/fullchain.pem'
$ws_ssl_cert='';
//WSS私钥', '一般為privkey.pem，宝塔默認位置：/www/server/panel/vhost/ssl/YOU DOMAIN/privkey.pem'
$ws_ssl_pk='';
