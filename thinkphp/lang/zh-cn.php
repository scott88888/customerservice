...
return [
    ...
    'Undefined index'                                           => '未定义數组索引',
    'Undefined offset'                                          => '未定义數组下标',
    'Parse error'                                               => '语法解析錯誤',
    'Type error'                                                => '类型錯誤',
    'Fatal error'                                               => '致命錯誤',
    'syntax error'                                              => '语法錯誤',
    ...
    'url suffix deny'                                           => '禁止的URL后缀訪問',
    'Route Not Found'                                           => '当前訪問路由未定义',
    'Undefined db type'                                         => '未定义資料库类型',
    'variable type error'                                       => '变量类型錯誤',
    'PSR-4 error'                                               => 'PSR-4 规范錯誤',
    'not support total'                                         => '简洁模式下不能取得資料总數',
    'not support last'                                          => '简洁模式下不能取得最后一頁',
    'error session handler'                                     => '錯誤的SESSION处理器类',
    ...
    'sae mc write error'                                        => 'SAE mc 写入錯誤',
    ...
    'closure not support cache(true)'                           => '使用闭包查詢不支持cache(true)，請指定缓存Key',

    // 上传錯誤訊息
    'unknown upload error'                                      => '未知上传錯誤！',
    'file write error'                                          => '文件写入失敗！',
    'upload temp dir not found'                                 => '找不到临时文件夹！',
    'no file to uploaded'                                       => '没有文件被上传！',
    'only the portion of file is uploaded'                      => '文件只有部分被上传！',
    'upload File size exceeds the maximum value'                => '上传文件大小超过了最大值！',
    'upload write error'                                        => '文件上传保存錯誤！',
    ...
    'directory {:path} creation failed'                         => '目录 {:path} 建立失敗！',
    ...
    'invalid Request method'                                    => '無效的請求类型',
    'invalid token'                                             => '令牌資料無效',
    'not conform to the rules'                                  => '规则錯誤',
];
