...
class Collection implements ArrayAccess, Countable, IteratorAggregate, JsonSerializable
{
    ...
    /**
     * 對資料排序，並返回排序後的資料组成的新 Collection 實例
     * @access public
     * @param  callable|null $callback 回调函數
     * @return static
     */
