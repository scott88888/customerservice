...
abstract class Model implements \JsonSerializable, \ArrayAccess
{
    ...
    // 更新自動完成列表
    protected $update = [];
    // 是否需要自動寫入時間戳 如果設定為字符串 則表示時間字段的類型
     ...
     * 取得當前模型的查詢對象
     * @access public
     * @param bool      $buildNewQuery  建立新的查詢對象
     * @return Query
     */
     ...
     * 取得當前模型的資料庫查詢對象
     * @access public
     * @param bool $useBaseQuery 是否调用全局查詢範圍
     * @param bool $buildNewQuery 建立新的查詢對象
     * @return Query
     */
    ...
    /**
     * 取得對象原始資料 如果不存在指定字段返回false
     * @access public
     * @param string $name 字段名 留空取得全部
     * @return mixed
     ...
     * 時間日期字段格式化處理
     * @access public
     * @param mixed $time      時間日期表达式
     * @param mixed $format    日期格式
     * @param bool  $timestamp 是否进行時間戳轉換
     * @return mixed
     */
     ...
     * 取得关联模型資料
     * @access public
     * @param Relation        $modelRelation 模型关联對象
     * @return mixed
     ...
     * 轉換當前模型資料集為資料集對象
     * @access public
     * @param array|\think\Collection $collection 資料集
     ...
     * 保存多个資料到當前資料對象
     * @access public
     * @param array   $dataSet 資料
     * @param boolean $replace 是否自動识别更新和寫入
     * @return array|false
     * @throws \Exception
     */
     ...
     * 設定允许寫入的字段
     * @access public
     * @param string|array $field 允许寫入的字段 如果為true只允许寫入資料表字段
     * @return $this
     */
     ...
     * 設定排除寫入的字段
     * @access public
     * @param string|array $field 排除允许寫入的字段
     * @return $this
     */
     ...
     * 設定字段驗證
     * @access public
     * @param array|string|bool $rule  驗證規則 true表示自動读取驗證器類
     ...
     * 命名範圍
     * @access public
     * @param string|array|\Closure $name 命名範圍名稱 逗号分隔
     * @internal  mixed                 ...$params 参數调用
     * @return Query
     */
     ...
     * @access public
     * @param string       $model 模型名
     * @param string|array $morph 多态字段訊息
