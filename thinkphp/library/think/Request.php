...
class Request
{
     ...
     * 当前的请求类型
     * @access public
     * @param bool $method true 取得原始请求类型
     * @return string
     */
     ...
     * 当前是否Ajax请求
     * @access public
     * @param bool $ajax true 取得原始ajax请求
     * @return bool
     */
     ...
     * 当前是否Pjax请求
     * @access public
     * @param bool $pjax true 取得原始pjax请求
     * @return bool
     */
