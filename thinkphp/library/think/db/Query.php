...
class Query
{
    ...
    /**
     * 分頁查詢
     * @param int|array $listRows 每頁数量 数组表示配置参数
     ...
     * 取得資料表訊息
     * @access public
     * @param mixed  $tableName 資料表名 留空自动取得
     ...
     * 取得当前資料表的主键
     * @access public
     * @param string|array $options 資料表名或者查詢参数
     * @return string|array
     */
