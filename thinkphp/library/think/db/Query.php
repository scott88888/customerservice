...
class Query
{
     ...
     * @param string $fetch     取得訊息类型 包括 fields type bind pk
     * @return mixed
     */
     ...
     * 缓存資料
     * @access public
     * @param string    $key    缓存標識
     * @param mixed     $data   缓存資料
