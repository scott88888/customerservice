...
class Query
{
    ...
    /**
     * 取得Join表名及别名 支援
     * ['prefix_table或者子查詢'=>'alias'] 'prefix_table alias' 'table alias'
     * @access public
     ...
     * 指定JOIN查詢字段
     * @access public
     * @param string|array $table 資料表
     * @param string|array $field 查詢字段
     * @param mixed        $on    JOIN條件
     * @param string       $type  JOIN類型
     * @return $this
     */
     ...
     * 去除查詢参數
     * @access public
     * @param string|bool $option 参數名 true 表示去除所有参數
     * @return $this
     */
    ...
    /**
     * 分頁查詢
     * @param int|array $listRows 每頁數量 數组表示配置参數
     * @param int|bool  $simple   是否简洁模式或者总记录數
     ...
     * 查詢快取
     * @access public
     * @param mixed             $key    快取key
     * @param integer|\DateTime $expire 快取有效期
     ...
     * 不主動取得資料集
     * @access public
     * @param bool $pdo 是否返回 PDOStatement 對象
     * @return $this
     */
     ...
     * 取得資料表訊息
     * @access public
     * @param mixed  $tableName 資料表名 留空自動取得
     * @param string $fetch     取得訊息類型 包括 fields type bind pk
     * @return mixed
     */
     ...
     * 取得當前資料表的主键
     * @access public
     * @param string|array $options 資料表名或者查詢参數
     * @return string|array
     */
     ...
     * 設定关联查詢JOIN预查詢
     * @access public
     * @param string|array $with 关联方法名稱
     * @return $this
     */
     ...
     * }])
     *
     * @param string | array $field 指定取得的字段
     * @return $this
     */
     ...
     * 設定关联查詢
     * @access public
     * @param string|array $relation 关联名稱
     * @return $this
     */
     ...
     * 通過Select方式插入记录
     * @access public
     * @param string $fields 要插入的資料表字段名
     ...
     * 產生快取標識
     * @access public
     * @param mixed     $value   快取資料
     * @param array     $options 快取参數
     * @param array     $bind    绑定参數
     * @return string
     */
     ...
     * 刪除记录
     * @access public
     * @param mixed $data 表达式 true 表示强制刪除
     * @return int
     * @throws Exception
     * @throws PDOException
     */
