...
class Angular
{
    ...
    public function parse($content)
    {
        ...
        while (true) {
            ...
            if ($num-- <= 0) {
                throw new Exception('解析出错, 超过了最大属性數');
            }
        }
    ...
    /**
     * 解析php-model指令, 方便做内容編輯功能，value会自動转移特殊字符(htmlentities)， 保证 input的value正确输出
     * @return string
     */
