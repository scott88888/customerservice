...
class Connection
{
     ...
     * 获得資料集
     * @access protected
     * @param bool|string       $class true 返回Mongo cursor對象 字符串用于指定返回的類名
     * @param string|array      $typeMap 指定返回的typeMap
     * @return mixed
     */
